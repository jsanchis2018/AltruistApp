...
public class Altruistapp {
    ...
    static DonacionDAO donacionDAO = new DonacionDAO();
    ...
    public static void registrarse() {
        ...
        while (true) {
            ...
            System.out.println("3. Revisar solicitudes");  // Nueva opción añadida
            ...
            switch (opcion) {
                ...
                case 2:
                    ...
                    break;
                case 3:
                    revisarSolicitudes();  // Llama al método para revisar solicitudes
                    break;
                case 4:
    ...
    public static void ofrecerDonacion() {
        System.out.println("\n---- OFRECER DONACIÓN ----");
    ...
    public static void aceptarDonacion() {
        System.out.println("\n---- ACEPTAR DONACIÓN ----");
